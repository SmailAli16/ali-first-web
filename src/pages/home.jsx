  ...
  return (
    <div className=" flex  gap-10 bg-phot ">
      <div className="flex flex-col h-screen gap-10 w-1/2 mx-10 m-2">
        <div className=" gap-6 flex justify-center items-center border border-base-300 p-10">
        ...
        <div className=" flex justify-center items-center gap-1 border border-base-300 p-10">
          <img src={phot} alt="" className=" w-3/5 h-52 pr-5" />
          <p className="  w-1/2 ">
            Grow your business while focusing on what you want to: making
            delicious food. Team up with foodora market and tap into a fresh
            audience.
